#!/bin/bash
aws s3 sync s3://pvq-build/data_post.sql ./data/ --profile r2 --endpoint-url https://b95f38ca3a6ac31ea582cd624e6eb385.r2.cloudflarestorage.com
aws s3 sync s3://pvq-build/highest-score-answers.json ./data/ --profile r2 --endpoint-url https://b95f38ca3a6ac31ea582cd624e6eb385.r2.cloudflarestorage.com
